...
class _UploadPageState extends State<UploadPage>
  ...
  TextEditingController _shortTextEdditingController = TextEditingController();
          ...
          ListTile(
            ...
            title: Container(
              ...
              child: TextField(
                ...
                controller: _shortTextEdditingController,
  ...
  ClearFormInfo() {
    setState(() {
      ...
      _shortTextEdditingController.clear();
    });
  }
  ...
  saveItemInfo(String downloadUrl) {
    ...
    itemsRef.document(productId).setData({
      "shortInfo": _shortTextEdditingController.text.trim(),
