...
import 'package:e_shop/option/chooseOption.dart';
import 'package:e_shop/option/th.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            RaisedButton(onPressed: (){
              ...
              builder: (c){
                    return ErrorAlertDialog(message: "please write email adn password.",);
              });
            },
              color: Colors.pink,
  ...
  void loginUser()async{
    ...
    if(firebaseUser!=null){
      readData(firebaseUser).then((s){
        Navigator.pop(context);
        Route route =MaterialPageRoute(builder: (c)=>b());
